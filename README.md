...
The changes to Phinch introduced by Blackbird are going to be merged into the main Phinch project (see [#63](https://github.com/PitchInteractiveInc/Phinch/issues/63)).
